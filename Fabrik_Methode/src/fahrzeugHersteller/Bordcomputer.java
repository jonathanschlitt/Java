...
public class Bordcomputer {
    ...
    public Bordcomputer(Device... devices) {
        // this.readConfig();
        // this.setDevices();
        installedDevices = new Device[devices.length];
        for (int i = 0; i < devices.length; i++) {
            installedDevices[i] = devices[i];
        }
        changeDevice();
    }
     ...
     * File(getClass().getResource(CONFIG_FILENAME).getFile());
     * 
     ...
     * System.err.println("Config file contains more than " + MAX_DEVICES +
     ...
     * } else {
     * System.err.println("Class " + this.deviceName[i] +
